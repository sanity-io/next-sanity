...
- [#3510](https://github.com/sanity-io/next-sanity/pull/3510) [`a1e48d2`](https://github.com/sanity-io/next-sanity/commit/a1e48d2aa79f1b00e8fa2f5cf97a1e5ed6879943) Thanks [@stipsan](https://github.com/stipsan)! - Remove `intervalOnGoAway` prop, change signature of `onGoAway`
  ...
  export const onGoAway: SanityLiveOnGoaway = (
    event,
    { includeDrafts },
    setPollingInterval
  ) => {
    ...
    console.warn(
      ...
      }> connection is closed after receiving a 'goaway' event, the server gave this reason:`,
...
- [#3470](https://github.com/sanity-io/next-sanity/pull/3470) [`a19c003`](https://github.com/sanity-io/next-sanity/commit/a19c003280e6f3b55dac7a7227881efac088cf6a) Thanks [@stipsan](https://github.com/stipsan)! - Removed the deprecated `tag` prop from `<SanityLive>`, use `requestTag` instead.
...
- [#3481](https://github.com/sanity-io/next-sanity/pull/3481) [`d121ef6`](https://github.com/sanity-io/next-sanity/commit/d121ef6e24f43f8f131d432ae4283b87602bd2b3) Thanks [@stipsan](https://github.com/stipsan)! - Remove the deprecated `useDraftModePerspective` hook
  ...
  async function DraftModePerspectiveProvider({
    children,
  }: {
    children: React.ReactNode;
  }) {
  ...
  export function DraftModePerspective({
    children,
  }: {
    children: React.ReactNode;
  }) {
  ...
  export const DraftModePerspectiveContext = createContext<
    "checking" | "unknown" | LivePerspective
  >("unknown");
  ```
...
- [#3536](https://github.com/sanity-io/next-sanity/pull/3536) [`7c18db6`](https://github.com/sanity-io/next-sanity/commit/7c18db6ce82f505c48255ae6a176e223a205a1a5) Thanks [@stipsan](https://github.com/stipsan)! - Replace the `revalidateSyncTags` prop on `<SanityLive>` with `action`
...
- [#3476](https://github.com/sanity-io/next-sanity/pull/3476) [`d588c58`](https://github.com/sanity-io/next-sanity/commit/d588c58a937075e923497f0494c7870a8969b947) Thanks [@stipsan](https://github.com/stipsan)! - Removed the deprecated `useIsLivePreview` hook
  ...
  export function IsLivePreviewProvider({
    children,
  }: {
    children: React.ReactNode;
  }) {
...
- [#3472](https://github.com/sanity-io/next-sanity/pull/3472) [`c19b9c8`](https://github.com/sanity-io/next-sanity/commit/c19b9c8c0eae76188a145cd7a8c3ba5d1ffbab8a) Thanks [@stipsan](https://github.com/stipsan)! - Removed the deprecated `tag` option from `sanityFetch`, use `requestTag` instead.
...
- [#3483](https://github.com/sanity-io/next-sanity/pull/3483) [`1dafa8f`](https://github.com/sanity-io/next-sanity/commit/1dafa8f913234bdeed83b5ec5cb8a4705ac18d5c) Thanks [@stipsan](https://github.com/stipsan)! - Removed the deprecated `useDraftModeEnvironment` hook
...
- [#3558](https://github.com/sanity-io/next-sanity/pull/3558) [`d281a23`](https://github.com/sanity-io/next-sanity/commit/d281a238f40575ae907c14a9b95907ab147c96cc) Thanks [@stipsan](https://github.com/stipsan)! - Change `sanityFetch` in `cacheComponents: false` mode to stop caching the internal sync-tag lookup request.
...
- [#3109](https://github.com/sanity-io/next-sanity/pull/3109) [`cd282e3`](https://github.com/sanity-io/next-sanity/commit/cd282e302bdfb243a17a32871c9a3f7c810b4d8d) Thanks [@stipsan](https://github.com/stipsan)! - Removed `type DefineSanityLiveOptions`, `type DefinedSanityFetchType` and `type DefinedSanityLiveProps` type exports

- [#3518](https://github.com/sanity-io/next-sanity/pull/3518) [`ee00392`](https://github.com/sanity-io/next-sanity/commit/ee003926449b1161b72c91ec883cb378e044f814) Thanks [@stipsan](https://github.com/stipsan)! - Renamed 3 type exports on `next-sanity/live`:
...
- [#3511](https://github.com/sanity-io/next-sanity/pull/3511) [`e05f69d`](https://github.com/sanity-io/next-sanity/commit/e05f69d6b6ae16eef7f2f8b4198f2b1e2992a1b1) Thanks [@stipsan](https://github.com/stipsan)! - Add `onRestart` prop on `<SanityLive>`, by default it calls `router.refresh()`. You can set `<SanityLive onRestart={false} />` to disable the default behavior.
...
- [#3553](https://github.com/sanity-io/next-sanity/pull/3553) [`b3300b8`](https://github.com/sanity-io/next-sanity/commit/b3300b85c8076f1b2f2395dde35159a1750c820b) Thanks [@stipsan](https://github.com/stipsan)! - Add `onReconnect` prop on `<SanityLive>`, by default it logs an error to the console. You can set `<SanityLive onReconnect={false} />` to disable the default behavior.
...
- [#3109](https://github.com/sanity-io/next-sanity/pull/3109) [`cd282e3`](https://github.com/sanity-io/next-sanity/commit/cd282e302bdfb243a17a32871c9a3f7c810b4d8d) Thanks [@stipsan](https://github.com/stipsan)! - Add `resolvePerspectiveFromCookies` export
...
- [#3533](https://github.com/sanity-io/next-sanity/pull/3533) [`adccd46`](https://github.com/sanity-io/next-sanity/commit/adccd4673808ad34f9f1eeb12a9b4773205eb743) Thanks [@renovate](https://github.com/apps/renovate)! - fix(deps): update sanity monorepo to v5.25.1
...
- [#3109](https://github.com/sanity-io/next-sanity/pull/3109) [`cd282e3`](https://github.com/sanity-io/next-sanity/commit/cd282e302bdfb243a17a32871c9a3f7c810b4d8d) Thanks [@stipsan](https://github.com/stipsan)! - Use private import for `#isCorsOriginError`

- [#3109](https://github.com/sanity-io/next-sanity/pull/3109) [`cd282e3`](https://github.com/sanity-io/next-sanity/commit/cd282e302bdfb243a17a32871c9a3f7c810b4d8d) Thanks [@stipsan](https://github.com/stipsan)! - Bump `@sanity/visual-editing`

- [#3109](https://github.com/sanity-io/next-sanity/pull/3109) [`cd282e3`](https://github.com/sanity-io/next-sanity/commit/cd282e302bdfb243a17a32871c9a3f7c810b4d8d) Thanks [@stipsan](https://github.com/stipsan)! - Implement onLiveEventIncludingDrafts

- [#3109](https://github.com/sanity-io/next-sanity/pull/3109) [`cd282e3`](https://github.com/sanity-io/next-sanity/commit/cd282e302bdfb243a17a32871c9a3f7c810b4d8d) Thanks [@stipsan](https://github.com/stipsan)! - Add back support for returning `refresh` to trigger `router.refresh()`

- [#3109](https://github.com/sanity-io/next-sanity/pull/3109) [`cd282e3`](https://github.com/sanity-io/next-sanity/commit/cd282e302bdfb243a17a32871c9a3f7c810b4d8d) Thanks [@stipsan](https://github.com/stipsan)! - Do not router.refresh() on reconnect events
