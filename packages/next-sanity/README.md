...
[LICENSE]: LICENSE
[migrate-v1-to-v4]: ./packages/next-sanity/MIGRATE-v1-to-v4.md
[migrate-v4-to-v5-app]: ./packages/next-sanity/MIGRATE-v4-to-v5-app-router.md
[migrate-v4-to-v5-pages]: ./packages/next-sanity/MIGRATE-v4-to-v5-pages-router.md
[migrate-v5-to-v6]: ./packages/next-sanity/MIGRATE-v5-to-v6.md
[migrate-v6-to-v7]: ./packages/next-sanity/MIGRATE-v6-to-v7.md
[migrate-v7-to-v8]: ./packages/next-sanity/MIGRATE-v7-to-v8.md
...
[preivew-app-router]: ./packages/next-sanity/PREVIEW-app-router.md
...
[preview-pages-router]: ./packages/next-sanity/PREVIEW-pages-router.md
